...
export class CopilotDeployer implements Deployer {
  ...
  private async deploySkills(
    ...
    const outputSkillsDirectory = `${targetDirectory}/.github/skills/`;
  ...
  private async deployAgents(
    ...
    const outputAgentsDirectory = `${targetDirectory}/.github/agents/`;
